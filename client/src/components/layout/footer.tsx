      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><Link href="/legal/privacy-policy" className="hover:text-white transition-colors">{t('privacyPolicy')}</Link></li>
              <li><Link href="/legal/distance-sales-contract" className="hover:text-white transition-colors">{t('termsOfService')}</Link></li>
              <li><Link href="/legal/delivery-and-refund-policy" className="hover:text-white transition-colors">{t('deliveryAndRefundPolicy')}</Link></li>
