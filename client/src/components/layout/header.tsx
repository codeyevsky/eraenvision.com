...
import { ChevronDown, Menu, X, Target, TrendingUp, BarChart3 } from 'lucide-react';
...
            {/* Aşağıdaki 'py-6 space-y-6' sınıflarını 'py-4 space-y-4' olarak değiştirdik */}
            <div className="px-4 sm:px-6 py-4 space-y-4"> 
              
              {/* Mobile Products Section */}
              <div>
                <div className="text-sm font-semibold text-gray-900 mb-4">{t('products')}</div>
                {/* Aşağıdaki 'space-y-3' sınıfını 'space-y-2' olarak değiştirdik */}
                <div className="space-y-2">
                  {/* Aşağıdaki her bir link için 'py-2' sınıfını 'py-1' olarak değiştirdik */}
                  <Link 
                    href="/launch" 
                    className="flex items-center gap-3 py-1 text-gray-600 hover:text-gray-900 transition-colors"
...
              {/* Aşağıdaki 'space-y-4' sınıfını 'space-y-2' olarak değiştirdik */}
              <div className="space-y-2 border-t border-gray-200 pt-4">
                {/* Aşağıdaki her bir link için 'py-2' sınıfını 'py-1' olarak değiştirdik */}
                <Link 
                  href="/dealbridge" 
                  className="block text-gray-600 hover:text-gray-900 transition-colors font-medium py-1"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  DealBridge
                </Link>
