...
// Resimlerinizi import edin
import launchImage from '../../../dist/public/assets/EraEnvision-AI-Entrepreneur-AI-Main-Menu.png';
import scaleImage from '../../../dist/public/assets/EraEnvision-SME-Main-Menu.png';
import investImage from '../../../dist/public/assets/EraEnvision-AI-Chatbot.png';
...
      cta: t('seeDetails'),
      link: '/invest',
      image: investImage, // Bu satırı güncelledik
    },
  ];
...
                onClick={() => setActiveTab(product.id)}
              >
                {/* Kartlardaki resimleri kaldırdık */}
